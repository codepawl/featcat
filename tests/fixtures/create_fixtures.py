    ...
    table = pa.table(
        {
            ...
            "timestamp": pa.array([f"2025-01-{d:02d}T00:00:00" for d in range(1, 16)], type=pa.string()),
            "cpu_usage": pa.array(
    ...
    table = pa.table(
        {
            ...
            "timestamp": pa.array([f"2025-01-{(d % 28) + 1:02d}T00:00:00" for d in range(20)], type=pa.string()),
